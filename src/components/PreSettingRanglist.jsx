...
export const PreSettingRanglist = ({ className = '', leads }) => {
        ...
        <section className={`flex w-full flex-col items-stretch justify-center px-3 sm:px-5 py-6 sm:py-8 border-[rgba(21,21,21,1)] border-b ${className}`}>
                        ...
                        <div key={index} className="bg-[rgba(255,255,255,0.09)] border p-4 rounded-[10px] border-[rgba(255,255,255,0.06)] border-solid">
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="flex justify-between">
                                    <span className="text-[rgba(139,139,139,1)]">Anwahlversuche:</span>
                                    <span className="text-white">{lead.anwahlversuche}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-[rgba(139,139,139,1)]">Erreicht:</span>
                                    <span className="text-white">{lead.erreicht}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-[rgba(139,139,139,1)]">Gesprächszeit:</span>
                                    <span className="text-white">{lead.gespraechszeit}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-[rgba(139,139,139,1)]">Gelegte Settings:</span>
                                    <span className="text-white">{lead.gelegteSettings}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-[rgba(139,139,139,1)]">Gelegte Closing:</span>
                                    <span className="text-white">{lead.gelegteClosing}</span>
                                </div>
                            </div>
                        </div>
                    ))
            ...
            <div className="hidden sm:block w-full">
                ...
                <div className="flex w-full items-center gap-4 lg:gap-8 text-sm text-[rgba(139,139,139,1)] font-normal leading-none flex-wrap pl-[18px] pr-2 py-2.5 rounded-[10px]">
                    ...
                    <div className="min-w-0 flex-1 truncate">Erreicht</div>
                    <div className="min-w-0 flex-1 truncate">Gesprächszeit</div>
                    <div className="min-w-0 flex-1 truncate">Gelegte Settings</div>
                    <div className="min-w-0 flex-1 truncate">Gelegte Closing</div>
                </div>
                    ...
                    {paginatedLeads.length > 0 ? (
                        paginatedLeads.map((lead, index) => (
                            ...
                            >
                                ...
                                <div className="min-w-0 flex-1 truncate">{lead.anwahlversuche}</div>
                                <div className="min-w-0 flex-1 truncate">{lead.erreicht}</div>
                                <div className="min-w-0 flex-1 truncate">{lead.gespraechszeit}</div>
                                <div className="min-w-0 flex-1 truncate">{lead.gelegteSettings}</div>
                                <div className="min-w-0 flex-1 truncate">{lead.gelegteClosing}</div>
                            </div>
                        ))
                    ) : (

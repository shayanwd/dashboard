...
export default function DoubleLineChart2() {
    ...
    const hasData = false; // Set to true when you have data

    // Bar data (screenshot jaisa)
    const barData = [
        { value: 0.8, color: '#7CF9F9', name: 'Bar 1' }, // Light cyan - left bar
        { value: 0.55, color: '#3B82F6', name: 'Bar 2' }, // Bright blue - right bar
    ];
        ...
        return (
            <div className="bg-[#FFFFFF17] rounded-xl p-6 w-full max-w-2xl">
                ...
                <div className="flex justify-start">
                    <button className="px-4 py-2 rounded-lg text-sm font-medium text-white bg-[#23272b] hover:bg-[#374151] transition-colors">
                        Show Up Quote
                    </button>
                </div>
            </div>
